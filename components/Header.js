    ...
    <div className='relative '>
         ...
         <div className='font-Montserrat text-3xl flex flex-col items-center gap-6 overflow-x-hidden'>
            <video autoPlay={true} muted={true} className="z-10 " >
                ...
                <button className='text-[2vw] bg-pink text-white md:font-bold px-[3vw] py-[2vw] md:text-[1vw] md:px-[2em] md:py-[1em] md:hover:bg-pink md:hover:text-white md:hover:px-[3.2em] md:hover:py-[1.2em] md:hover:text-1.5xl duration-500 md:hover:font-bold '> HIRE US {">>"} </button>
